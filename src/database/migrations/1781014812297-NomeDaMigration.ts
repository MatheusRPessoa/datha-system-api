...
export class NomeDaMigration1781014812297 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_status_enum" AS ENUM('ATIVO', 'INATIVO', 'EXCLUIDO')`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'atendimento', 'producao', 'acabamento', 'entrega')`);
