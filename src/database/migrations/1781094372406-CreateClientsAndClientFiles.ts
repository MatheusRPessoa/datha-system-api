...
export class CreateClientsAndClientFiles1781094372406 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "client_files" ADD CONSTRAINT "FK_0e81f52c57bee1687552219a2e9" FOREIGN KEY ("CLIENT_ID") REFERENCES "clients"("ID") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "client_files" DROP CONSTRAINT "FK_0e81f52c57bee1687552219a2e9"`,
    );
